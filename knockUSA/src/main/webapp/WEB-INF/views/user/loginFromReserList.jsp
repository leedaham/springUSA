        ...
        <div>
            ...
            <div class="login_from_resvLi">
                ...
                <div class="non_member">
                    ...
                    <span class="row">
                        <span>Name</span>
                        <input type="text" name="nonuserName" title="이름">
                    </span>
                    <span class="row">
                        <span>Reservation Number</span>
                        <input type="text" name="resvNo1" title="예약번호1">
                        <input type="text" name="resvNo2" title="예약번호2">
                    </span>
                    <div>
                        <button type="button" class="btn btn_login"><a href="#">조회하기</a></button>
                    </div>
                </div>
            </div>
        </div>
